...
export default function ServicePage({ pagedata, city, cat }) {
  ...
  return (
    <div className=" ">
      <div className="flex md:flex-row flex-col  common-spacing">
        <div className="left-side bg-white rounded-2xl shadow-md p-4 lg:w-1/4 flex-col mb-1.5">
        ...
        <div className=" lg:w-3/4">
          <div className="flex md:flex-row flex-col px-2 justify-center">
            <div className="md:w-2/3 px-3 w-full">
              ...
              <div className="desktopBanner mb-3.5 flex items-center justify-center relative  ">
                {!imageLoader && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Image
                      src="/assets/images/serviceBannerimg.jpg"
                      alt="Loading"
                      width={475}
                      height={345}
                      style={{
               ...
               <div className=" desktopBanner mb-3.5 h-64 w-full rounded-2xl flex items-center justify-center cat-service-style"></div>
              </div>
            ...
            <div className="md:w-1/3 cartContainer">
