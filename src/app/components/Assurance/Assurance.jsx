        ...
        <div className="assuredContainer">
            ...
            <div className="assureBody">
                <div className="assureList">
                    <li className="assureListItems">Authentic Parts</li>
                    <li className="assureListItems">Best Value</li>
                    <li className="assureListItems">Trusted Service</li>
                    <li className="assureListItems">Skilled Experts</li>
                </div>
