...
function BookingSlots({ phoneNumber }) {
  ...
  return (
    <div className="bookingContainer">
      <div className='bg-blue-500 text-white flex flex-row items-center justify-center gap-2.5 p-5 rounded-xl mb-4'>
        <FontAwesomeIcon icon={faBook} />
        <h3 className='text-xl'>Booking Confirmation</h3>
      </div>
      
      <div className="bookingDetails flex flex-col gap-3">
