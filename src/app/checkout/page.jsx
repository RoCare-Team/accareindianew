...
const CheckOut = () => {
    ...
    const handlePaymentCompleted = async (leadtype) => {
        ...
        const source = 'AC Care India website';
                                ...
                                <div>
                                    {cartDataArray?.map((service) => (
                                        <div key={service.cart_id} >
                                            ...
                                            {service.cart_dtls.map((service) => (
                                                <div key={service.service_id} className="checkout-item service-card2 flex items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-gray-500" dangerouslySetInnerHTML={{ __html: service.description }}></p>
                                                    </div>
                                            ...
                                            <button className="bg-blue-600 w-full p-2 rounded-xl text-white" onClick={() => handlePaymentCompleted(service.category_cart_id)}>Pay Now: ₹{service.total_main} </button>
                                        </div>
